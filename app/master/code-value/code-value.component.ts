...
import { AddCodeValueComponent } from './add-code-value/add-code-value.component';
...
@Component({
  ...
  standalone: true,
  imports: [SharedModule, AddCodeValueComponent]
})
export class CodeValueComponent {
  ...
  getTableData() {
    ...
    this.sb.tableData = this.api.get(ApiRoutes.CodeValue, params).subscribe((res) => {
  ...
  onAddRecord() {
    this.ref = this.ds.dialog.open(AddCodeValueComponent, {
